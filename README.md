...
Next you'll need to get the SDK. SDK stands for Software Development Kit, and SDKs are usually a program that brings together various tools to help you work with a specific technology. SDKs will be available for all the major languages and platforms, for instance the Aylien SDK brings together a bunch of tools and functions that will make it possible to interface with their API from our server and is available for Node, Python, PHP, Go, Ruby and many others. We are going to use the Node one, the page is available [here](https://docs.aylien.com/newsapi/sdks/#javascript-node-js-sdk). You get 1000 free requests per day.

### Step 3: Require the SDK package
[Install the SDK](https://docs.aylien.com/newsapi/sdks/#installation) in your project and then we'll be ready to set up your server/index.js file.
